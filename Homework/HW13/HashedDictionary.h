// HW13 Line 166
// HashedEntry<KeyType, ItemType>* newnode = new HashedEntry<KeyType, ItemType>(newItem, searchKey);
...
// ans2: q/使其可以根據 searchKey 找到 record entry，並回傳
template <class KeyType, class ItemType>
...
// ans3: c/使其可以刪除 table  中所有的紀錄，要確實將每筆刪除
template <class KeyType, class ItemType>
...
// ans1: d/使其可以visit (顯示) table 中所有的紀錄
template <class KeyType, class ItemType>
