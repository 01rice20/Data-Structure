...
{
   bool hasRoomToAddF = (itemCount < maxItems);
	if (hasRoomToAddF)
	{
...
bool ArrayBag<ItemType>::removeFirst()
{
   ...
   bool canRemoveFirst = !isEmpty();
	...
	return canRemoveFirst;
} // end removeFirst

template <class ItemType>
bool ArrayBag<ItemType>::deleteFirst()
{
   bool candeleteFirst = !isEmpty();
	if (candeleteFirst)
	{
