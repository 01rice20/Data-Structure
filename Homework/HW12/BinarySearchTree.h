...
// ans1: 呼叫 findMinimumNode(...)，找到binary search tree 中 item 值最小的 node，藉由參數 minimumValue 回傳其 item 值
template<class ItemType>
...
// ans2: Recusively 呼叫此方法，直到找到 binary search tree 中 item 值最小的 node 後，回傳其位址
template<class ItemType>
