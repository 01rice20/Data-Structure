...
template<class KeyType, class ItemType>
HashedEntry<KeyType, ItemType>::HashedEntry():nextPtr(nullptr), count(0)
{
}

template<class KeyType, class ItemType>
HashedEntry<KeyType, ItemType>::HashedEntry(ItemType newEntry, KeyType searchKey):nextPtr(nullptr), count(0)
{
	setItem( newEntry );
	setKey( searchKey ); 
}
