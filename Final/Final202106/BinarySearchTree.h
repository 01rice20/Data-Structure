...
protected:
   ...
   bool isAllSingle_Recu(BinaryNode<ItemType>* subtreePtr, const ItemType target);
   bool isAllSingle_Iter(BinaryNode<ItemType>* subtreePtr, const ItemType target);
   int nodesOfOnlyChild_Recu(BinaryNode<ItemType>* subtreePtr);
   int nodesOfOnlyChild_Iter(BinaryNode<ItemType>* subtreePtr);
...
//   bool contains(const ItemType& anEntry) const;
   ...
   bool isAllSingleR(const ItemType target);
   bool isAllSingleI(const ItemType target);
   int nodesOfOnlyChildR();
   int nodesOfOnlyChildI();
...
template<class ItemType>
int BinarySearchTree<ItemType>::nodesOfOnlyChildR()
{
	return nodesOfOnlyChild_Recu(rootPtr);
}

template<class ItemType>
int BinarySearchTree<ItemType>::nodesOfOnlyChild_Recu(BinaryNode<ItemType>* subtreePtr)
{
...
template<class ItemType>
int BinarySearchTree<ItemType>::nodesOfOnlyChildI()
{
	return nodesOfOnlyChild_Iter(rootPtr);
}

template<class ItemType>
int BinarySearchTree<ItemType>::nodesOfOnlyChild_Iter(BinaryNode<ItemType>* subtreePtr)
{
	// add your code here
	...
	if(subtreePtr->getLeftChildPtr() && !subtreePtr->getRightChildPtr())
		return 1 + nodesOfOnlyChild_Iter(subtreePtr->getLeftChildPtr());
	else if(!subtreePtr->getLeftChildPtr () && subtreePtr->getRightChildPtr())
		return 1 + nodesOfOnlyChild_Iter(subtreePtr->getRightChildPtr());
	else if(subtreePtr->getLeftChildPtr() && subtreePtr->getRightChildPtr())
		nodesOfOnlyChild_Iter(subtreePtr->getLeftChildPtr());
		nodesOfOnlyChild_Iter(subtreePtr->getRightChildPtr());
	

}

template<class ItemType>
bool BinarySearchTree<ItemType>::isAllSingleR(const ItemType target)
{
	return (isAllSingle_Recu(rootPtr, target));
}

template<class ItemType>
bool BinarySearchTree<ItemType>::isAllSingle_Recu(BinaryNode<ItemType>* subtreePtr, const ItemType target)
{
	// add your code here
	if(!subtreePtr->getLeftChildPtr() && !subtreePtr->getRightChildPtr())
		return true;
	...
	if(subtreePtr->getLeftChildPtr() && !subtreePtr->getRightChildPtr())
		isAllSingle_Recu(subtreePtr->getLeftChildPtr(), target);
	else if(!subtreePtr->getLeftChildPtr ()&& subtreePtr->getRightChildPtr())
		isAllSingle_Recu(subtreePtr->getRightChildPtr(), target);
	else if(subtreePtr->getLeftChildPtr() && subtreePtr->getRightChildPtr())
		return false;
...
template<class ItemType>
bool BinarySearchTree<ItemType>::isAllSingleI(const ItemType target)
{
	return (isAllSingle_Iter(rootPtr, target));
}

template<class ItemType>
bool BinarySearchTree<ItemType>::isAllSingle_Iter(BinaryNode<ItemType>* subtreePtr, const ItemType target)
{
